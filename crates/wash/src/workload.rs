...
pub fn resolve_workload(
    ...
    Ok(ResolvedWorkload {
        ...
        allowed_host_loopback_ports: workload.allowed_host_loopback_ports.clone(),
    })
}
...
pub fn resolve_component_workload(
    ...
    let allowed_host_loopback_ports = component
        .allowed_host_loopback_ports
        .clone()
        .unwrap_or_else(|| base.allowed_host_loopback_ports.clone());
